...
class StoreFacturaRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'company.ruc.size' => 'El RUC debe tener exactamente 11 dígitos.',
            'company.razon_social.required' => 'La razón social de la empresa es obligatoria.',
            'company.nombre_comercial.required' => 'El nombre comercial de la empresa es obligatorio.',
            'company.address.ubigueo.required' => 'El ubigeo es obligatorio.',
            'company.address.ubigueo.size' => 'El ubigeo debe tener 6 caracteres.',
            'company.address.departamento.required' => 'El departamento es obligatorio.',
            'company.address.provincia.required' => 'La provincia es obligatoria.',
            'company.address.distrito.required' => 'El distrito es obligatorio.',
            'company.address.urbanizacion.required' => 'La urbanización es obligatoria.',
            'company.address.direccion.required' => 'La dirección es obligatoria.',
            'company.address.cod_local.required' => 'El código de local es obligatorio.',
            'company.address.cod_local.size' => 'El código de local debe tener 4 caracteres.',
